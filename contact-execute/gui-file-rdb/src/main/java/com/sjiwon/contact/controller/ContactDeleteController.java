...
import com.sjiwon.contact.application.ContactGuiFileInteractProcessor;
...
import com.sjiwon.contact.view.ContactDeleteFrame;
...
public class ContactDeleteController extends AbstractFrameController {
    ...
    private String[][] getMovieArray() {
        ...
        for (int i = 0; i < contactRecords.size(); i++) {
            ...
            contactArray[i][4] = contactRecords.get(i).organizeCreatedAt();
