package com.sjiwon.contact.execute.consolefile;
...
import com.sjiwon.contact.execute.consolefile.exception.DuplicateResourceException;
import com.sjiwon.contact.execute.consolefile.exception.InvalidAgeException;
import com.sjiwon.contact.execute.consolefile.exception.InvalidDeleteOperationException;
import com.sjiwon.contact.execute.consolefile.exception.InvalidMenuException;
import com.sjiwon.contact.execute.consolefile.exception.InvalidNameException;
import com.sjiwon.contact.execute.consolefile.exception.InvalidPhoneException;
...
public class FileContact {
    ...
    private void add() {
        ...
        final Contact contact = new Contact(
                fileInteractor.getLastId(FileInteractType.CONSOLE) + 1,
                name,
